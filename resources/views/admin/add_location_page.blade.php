            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Thêm nơi ở</li>
                </ol>
              </div>
            </div>
          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <select name="post_type" id="post_type" class="form-control" required>
                              <option selected value="Khách sạn">Khách sạn</option>
                    ...
                    <div class="row mb-4">
                      <div class="col-8">
                        <div class="form-group">
                          ...
                          <input type="text" name="location" class="form-control" id="exampleInputEmail1" required>
                        </div>
                      </div> 
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="website" class="form-control" id="exampleInputEmail1" required>
                        </div>
                      </div> 
                    </div>
                    ...
                    <div class="row mb-4">
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="ggmap" class="form-control" id="exampleInputEmail1" required>
                        </div>
                      </div> 
                    </div>
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-4">
                        <div class="div_center">
                            ...
                            <br>
                            <!-- <input type="file" name="main_image" id=""> -->
                            <input type="file" name="image1" id="sub_image1" accept="image/*" required>
                            <br><br>
                      ...
                      <div class="col-4">
                        <div class="div_center">
                            ...
                            <br>
                            <!-- <input type="file" name="main_image" id=""> -->
                            <input type="file" name="image2" id="sub_image2" accept="image/*" required>
                            <br><br>
